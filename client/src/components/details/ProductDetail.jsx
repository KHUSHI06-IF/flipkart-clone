    ...
    return (
        <>
            ...
            <SmallText>
                ...
                <Typography><StyledBadge />Partner Offer Extra 10% off upto ₹500 on next furniture purchase</Typography>
                <Typography><StyledBadge />Buy  2 items save 5% Buy 3 or move save 10% T&C</Typography>
            ...
            <Table>
                <TableBody>
                    <ColumnText>
                        ...
                        <TableCell style={{ fontWeight: 600 }}>Delivery by {date.toDateString()} | ₹100</TableCell>
                    </ColumnText>
                    <ColumnText>
